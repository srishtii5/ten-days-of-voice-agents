...
print("📚 SELLING Srishti's courses")
...
DEFAULT_FAQ = [
    ...
    },
    {
        ...
        "answer": "Yes! Srishti releases weekly tutorials on her website for free. The paid courses offer deep-dives, code reviews, and certification."
    },
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Srishti's Store'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with Srishti and email you." (Don't hallucinate prices).
            """,
